...
var getTopDoctorHomeService = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(numOfdoctors) {
  ...
  return function getTopDoctorHomeService(_x) {
...
var validateInput = function validateInput(inputData) {
  var requiredFields = ["doctorId", "selectedPrice", "selectedPayment", "selectedProvince", "nameClinic", "addressClinic", "note", "specialtyId", "clinicId"];
  var isValid = true;
  var emptyEle = "";
...
var saveInfoDoctor = function saveInfoDoctor(inputData) {
  return new Promise( /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(resolve, reject) {
      var checkInput, doctorMarkdown, markdownID, updatedData, doctorInfo;
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            console.log(inputData);
            checkInput = validateInput(inputData);
            ...
            resolve({
              errCode: 1,
              errMsg: " Missing one or more required fields ".concat(checkInput.emptyEle)
            });
            _context4.next = 34;
            break;
          case 9:
          ...
          case 17:
            doctorMarkdown = _context4.sent;
            markdownID = doctorMarkdown.id;
            if (!doctorMarkdown) {
              _context4.next = 23;
              break;
            }
            ...
            _context4.next = 23;
            return _index["default"].Markdown.update(updatedData, {
              where: {
                id: markdownID
              }
            });
...
var getScheduleDoctorByDateService = function getScheduleDoctorByDateService(doctorId, date) {
  return new Promise( /*#__PURE__*/function () {
...
var getExtraInforDoctorByIDService = function getExtraInforDoctorByIDService(doctorId) {
  return new Promise( /*#__PURE__*/function () {
...
var getListPatientsBookedService = function getListPatientsBookedService(doctorId, date) {
  return new Promise( /*#__PURE__*/function () {
...
module.exports = {
  ...
  getListPatientsBookedService: getListPatientsBookedService,
